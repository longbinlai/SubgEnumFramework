...
public class HyperGraphStageFourDriver extends Configured implements Tool{

	public int run(String[] args) throws IOException, ClassNotFoundException, InterruptedException, URISyntaxException {
		Configuration conf = getConf();
		// The parameters: <inputDir> <stageThreeOutputDir> <outputDir> <numReducers> <jarFile>
		...
		MultipleInputs.addInputPath(job, 
				...
				HyperGraphStageFourMapper1.class);
		
		MultipleInputs.addInputPath(job, 
				new Path(stageThreeOutput),
				SequenceFileInputFormat.class,
				HyperGraphStageFourMapper2.class);
